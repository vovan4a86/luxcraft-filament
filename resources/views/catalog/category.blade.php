        ...
        <div class="catalog-view__container container">
            ...
            <div class="catalog-view__heading">
                <div class="page-title oh">
                    <span data-aos="fade-down" data-aos-duration="900">{{ $category->name }}</span>
                </div>
            </div>
            @if (count($children))
            ...
            @else
                ...
                <div class="cards-view__grid">
                    @foreach($products as $product)
                        @include('catalog.product_card', compact('product'))
                    @endforeach
{{--                    <div class="cards-view__item cards-view__item--wide" data-aos="fade-down" data-aos-duration="900" data-aos-delay="550">--}}
{{--                        <div class="b-action">--}}
...
{{--                                <button class="b-action__btn btn-reset" type="button" data-request="data-request" data-src="#calc" data-label="Заказать бесплатный расчёт" aria-label="заказать бесплатный расчёт">--}}
